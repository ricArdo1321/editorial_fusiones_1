...
const HalftoneDot: React.FC = () => {
  ...
  return (
    ...
    >
      {/* The base dot */}
      <div 
        className={`w-8 h-8 bg-brand rounded-full transition-all duration-500 ease-out z-10 ${
      ...
      {/* The explosion */}
      <div 
        className={`absolute inset-0 bg-halftone-pattern bg-[length:12px_12px] rounded-full transition-all duration-700 ease-out mix-blend-screen ${
      ...
      {/* Secondary ring */}
       <div 
        className={`absolute inset-0 border border-brand/30 rounded-full transition-all duration-1000 ease-out delay-75 ${
